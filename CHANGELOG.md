...
- [] Lock model dependencies when logging a model (#15875, @harupy)
- [Model Registry] Initial implementation of prompt optimization method (#15861, @TomeHirata)
- [Tracking] Support custom request/response preview (#15919, @B-Step62)
- [Tracking] Add integration for AutoGen > 0.4 (#14729, @TomeHirata)
- [] Add type hints to dev/show_package_release_dates.py (#15904, @Copilot)
...
- [] Allow multi inputs module in DSPy (#15859, @TomeHirata)
...
- [] Redesign API reference page (#15811, @besirovic)
